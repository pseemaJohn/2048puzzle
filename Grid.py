...
class Grid:
    ...
    def merge(self, cells):
        ...
        while i < len(cells) - 1:
            ...
            i += 1
# This function checks if the cells can move in the 4 direction by checking two condition \
# first is using the matrix [1,0] combination using directionVectors to identify the result location
# Then check if result location as same value of current cell or is it 0, in which case return 0
# the above check is applicable only if there is a value else its 0.
